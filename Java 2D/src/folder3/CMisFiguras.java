...
public class CMisFiguras
{
    ...
    //Esta es la figura que se guarda y dibuja
    private Shape figura = null;
    private boolean seleccion = false; //Para saber si la figura esta seleccionada o no, por defecto no estará seleccionada
    ...
    /**
     * @param colorContorno1 the color_Contorno1 to set
     */
    public void setColor_Contorno1(Color colorContorno1)
    {
        this.color_Contorno1 = colorContorno1;
    }
